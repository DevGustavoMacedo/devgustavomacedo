const data = [
  ...
  {
    title: 'ToDo List',
    link: 'https://tsreact-todolist.vercel.app/',
    image: '/todo-list.webp',
    about:
      'A classic never gets old! A fully interactive ToDO List, you can add, edit, delete and close your tasks.',
    made: [
      { name: 'TypeScript', logo: 'typescript' },
      { name: 'ReactJS', logo: 'react' },
    ],
